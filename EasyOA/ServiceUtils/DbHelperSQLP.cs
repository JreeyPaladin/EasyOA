...
namespace ServiceUtils
{
    ...
    public class DbHelperSQLP
    {
        ...
        /// <returns></returns>
        public bool Exists(string strSql, object cmdParms)
        {
        ...
        /// <param name="cmdParms"></param>
        /// <returns>查询结果（object）</returns>
        public object GetSingle(string SQLString, object cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand())
        ...
        /// <param name="cmdParms"></param>
        /// <returns>SqlDataReader</returns>
        public SqlDataReader ExecuteReader(string SQLString, object cmdParms)
        {
            SqlConnection connection = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand();
            try
        ...
        /// <param name="cmdParms"></param>
        /// <returns>DataSet</returns>
        public DataSet Query(string SQLString, object cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand();
        ...
        private void PrepareCommand(SqlCommand cmd, SqlConnection conn, SqlTransaction trans, string cmdText, object cmdParms)
        {
            ...
            if (cmdParms != null)
            {
                if (cmdParms is SqlParameter[])
                {
                    foreach (SqlParameter parameter in (SqlParameter[])cmdParms)
                    {
                ...
                else if (cmdParms is IList<SqlParameter>)
                {
                    foreach (SqlParameter parameter in (IList<SqlParameter>)cmdParms)
                    {
                        if ((parameter.Direction == ParameterDirection.InputOutput || parameter.Direction == ParameterDirection.Input) &&
                            (parameter.Value == null))
                        {
                ...
                else if (cmdParms is SqlParameter)
                {
